	...
	<div class="columns is-mobile">
	  <div class="column has-text-centered has-centered">
	    <div class="content">
	      Temps de cuisson: <?php echo $recipe->time ?>mn
	    </div>
	  </div>
	  <div class="column has-text-centered has-centered">
	    <div class="content">
         Nb personnes: <div id="personnes"><?php echo $recipe->peopleNb ?></div>
	  ...
	  <div class="column has-text-centered has-centered">
	    <div class="content">
	      <p>Difficulté: facile <?php echo $recipe->difficulty ?>/4</p>
	      </div>
	  </div>
	</div>
	<div class="columns is-mobile">
	    ...
	    <div class="content">
	      ...
	      <ul>
            ...
            <li>
              ...
              <?php echo $ingredient->quantity ?> <?php echo $ingredient->quantity_unit ?>
            </li>
            <?php endforeach ?>
	      </ul>
	    </div>
