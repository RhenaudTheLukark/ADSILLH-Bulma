    ...
    <section class="section">
      <div class="container">
        ...
        <?php foreach ($dummy as $ingredient): ?>
          <form method="POST" action="http://adsillh-bulma.fr/index.php/ingredients/update" class="field has-addons has-addons-centered">
            <div class="control">
        ...
        <?php endforeach ?>
        <form method="POST" action="http://adsillh-bulma.fr/index.php/ingredients/insert" class="field has-addons has-addons-centered">
          <div class="control">
